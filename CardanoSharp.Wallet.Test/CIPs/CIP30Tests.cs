...
public class CIP30Tests
{
    ...
    public void TransactionUnspentOutput_Serialization_Test()
    {
        TransactionUnspentOutput unspentOutput = new TransactionUnspentOutput()
        {
            ...
            {
                TransactionId =
                    "E1DBF61F88853BB413EBD4681A5D0DCF7E6D48785463F348B9739CCC4F7D3069".HexToByteArray(),
                TransactionIndex = 1
            },
            Output = new TransactionOutput()
            {
                Address =
                    "005A99CB175EB944462D6BFD29D06E0A69DEFC091D8E5ECAB740AFAC6F1922FCDEEB6DF8592D78B20C6E22FDB73FA9446AAD05626D78000B7F".HexToByteArray(),
        ...
        var expectedCbor =
            "";
    ...
    public void Utxo_Serialization_Test()
    {
        Utxo utxo = new Utxo()
        {
            ...
            TxIndex = 0,
            OutputAddress =
                "addr_test1qpdfnjcht6u5g33dd07jn5rwpf5aalqfrk89aj4hgzh6cmceyt7da6mdlpvj679jp3hz9ldh8755g64dq43x67qqpdls6uzr2z",
            Balance = new Balance()
            {
                Lovelaces = 1344798,
        ...
        var expectedCbor =
            "";
        Assert.Equal(expectedCbor, actualCbor);
    }
    ...
    public void DataSignature_Verification_Test()
    {
        ...
        {
            Key =
                "a4010103272006215820069459f11edf67ae33bb6c3642bd0e69b405c50dbea5c7bf4cfbdf60059e5fce",
            Signature =
                ""
        };
